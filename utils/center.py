...
def pressure_cal(message: str) -> None:
    ...
    return pressure / 760 if value_p == 0 else pressure / 14.69 if value_p == 1 else pressure
...
def volume_cal(message: str) -> None:
    ...
    return volume / 1000 if value_v == 0 else volume
...
def temperature_cal(message: str) -> None:
    ...
    return temperature + 273 if value_t == 0 else temperature
...
def grams_cal(message: str) -> None:
    ...
    return grams * 1000 if value_g == 0 else grams
